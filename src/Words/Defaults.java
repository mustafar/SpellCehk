...
/**
 * 
 * @author Mustafa Define all the configurable values of the package
 */
public class Defaults {
    ...
    /**
     * Define if spell check considers only other words of the same length
     * (Otherwise, we will use words of length +1 and -1)
     */
    public static final Boolean matchOnlyExactLength = false;

    /**
     * Flag to apply RULE-WS (Word Sizes) RULE-WS: the difference in length with
     * the word you are looking for is never more than 1
     */
    public static final Boolean useRuleWS = true;

    /**
     * Flag to apply RULE-FL (First Letter) RULE-FL: you don't misspell a word
     * by typing the first letter wrong
     */
